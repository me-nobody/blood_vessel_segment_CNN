...
#SBATCH --job-name=unet_effb7_1024px_final   # some descriptive job name of your choice
...
srun python3 /users/ad394h/Documents/microvascular_proliferation/scripts/sm_unet_efficientnet_2_class_1024px_mvp.py
