...
#SBATCH --job-name=run_optim_bs50   # some descriptive job name of your choice
...
srun python3 /users/ad394h/Documents/segment_blood_vessels/scripts/sm_unet_efficientnet_2_class_bs50_drp2.py
echo "dropout2 completed"
srun python3 /users/ad394h/Documents/segment_blood_vessels/scripts/sm_unet_efficientnet_2_class_bs50_drp3.py
echo "dropout3 completed"
srun python3 /users/ad394h/Documents/segment_blood_vessels/scripts/sm_unet_efficientnet_2_class_bs50_drp5.py
