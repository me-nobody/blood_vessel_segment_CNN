...
log_file = '/users/ad394h/Documents/segment_blood_vessels/logs/sm_unet_effi_2_class_final{}.txt'.format(timestr)
...
filename = "history_unet_effi_aug_data_256px_final_" + str(timestr) + ".csv"

history = fit(epoch, model, train_loader, test_loader, criterion, optimizer, sched)

timestr = time.strftime("%Y%m%d-%H%M%S")
try:
    torch.save(model, '/users/ad394h/Documents/segment_blood_vessels/models/sm_unet_eff_b7_2class_256px_final_{}.pt'.format(timestr))
...
plot_loss(history)
plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/unet_efficientnet_2class_loss_final_{}.jpg".format(timestr))
plt.clf() # clear the above plot
plot_score(history)
plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/unet_efficientnet_2class_score_final_{}.jpg".format(timestr))
plt.clf()
plot_acc(history)
plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/unet_efficientnet_2class_accuracy_final_{}.jpg".format(timestr))
