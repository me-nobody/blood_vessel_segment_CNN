...
#SBATCH --job-name=run_optim_bs50_drp0   # some descriptive job name of your choice
...
srun python3 /users/ad394h/Documents/segment_blood_vessels/scripts/sm_unet_efficientnet_2_class_bs50_drp0.py
