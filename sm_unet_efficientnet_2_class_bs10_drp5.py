...
log_file = '/users/ad394h/Documents/segment_blood_vessels/logs/sm_unet_effi_2_class_bs10_drp5_{}.txt'.format(timestr)
...
for lr in max_lr_list:
    ...
    file_name = "history_bs10_drp5_" + str(lr) + ".csv"
    ...
    try:
        ...
        plot_loss(history)
        plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs10_drp5_loss_{}.jpg".format(lr))
        plt.clf() # clear the above plot
        plot_score(history)
        plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs10_drp5_score_{}.jpg".format(lr))
        plt.clf()
        plot_acc(history)
        plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs10_drp5_accuracy_{}.jpg".format(lr))
