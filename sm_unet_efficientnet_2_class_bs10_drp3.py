...
log_file = '/users/ad394h/Documents/segment_blood_vessels/logs/sm_unet_effi_2_class_bs10_drp3_{}.txt'.format(timestr)
...
for lr in max_lr_list:
    ...
    file_name = "history_bs10_drp3_" + str(lr) + ".csv"
    ...
    try:
        ...
        plot_loss(history)
        plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs10_drp3_loss_{}.jpg".format(lr))
        plt.clf() # clear the above plot
        plot_score(history)
        plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs10_drp3_score_{}.jpg".format(lr))
        plt.clf()
        plot_acc(history)
        plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs10_drp3_accuracy_{}.jpg".format(lr))
