...
#SBATCH --job-name=run_optim_bs20   # some descriptive job name of your choice
...
srun python3 /users/ad394h/Documents/segment_blood_vessels/scripts/sm_unet_efficientnet_2_class_bs20_drp0.py
echo "dropout0 completed"
srun python3 /users/ad394h/Documents/segment_blood_vessels/scripts/sm_unet_efficientnet_2_class_bs20_drp2.py
echo "dropout2 completed"
srun python3 /users/ad394h/Documents/segment_blood_vessels/scripts/sm_unet_efficientnet_2_class_bs20_drp3.py
echo "dropout3 completed"
srun python3 /users/ad394h/Documents/segment_blood_vessels/scripts/sm_unet_efficientnet_2_class_bs20_drp5.py
