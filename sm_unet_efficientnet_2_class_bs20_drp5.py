...
log_file = '/users/ad394h/Documents/segment_blood_vessels/logs/sm_unet_effi_2_class_bs20_drp5_{}.txt'.format(timestr)
...
model = torch.load('/users/ad394h/Documents/segment_blood_vessels/models/models_2_test/Unet_efficientnet_2_class_dropout_5.pt')
...
for lr in max_lr_list:
    ...
    file_name = "history_bs20_drp5_" + str(lr) + ".csv"
    ...
    try:
        ...
        plot_loss(history)
        plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs20_drp5_loss_{}.jpg".format(lr))
        plt.clf() # clear the above plot
        plot_score(history)
        plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs20_drp5_score_{}.jpg".format(lr))
        plt.clf()
        plot_acc(history)
        plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs20_drp5_accuracy_{}.jpg".format(lr))
