...
############# SLURM SETTINGS #############
#SBATCH --account=ad394h   # account name (mandatory), if the job runs under a project then it'll be the project name, if not then it should =none
#SBATCH --job-name=demo_job        # some descriptive job name of your choice
...
module load apps/tensorflow/2.13.0
#module load libs/xxx

############# MY CODE #############
echo "Hello from $SLURM_JOB_NODELIST"
python3 demo_ml_script_020424.py