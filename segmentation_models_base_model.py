...
model = torch.load('/users/ad394h/Documents/segment_blood_vessels/models/Unet_Resnet_base_model.pt')
        ...
        for i, data in enumerate(train_loader):
            ...
            if min_loss > (test_loss/len(test_loader)):
                ...
                if decrease % 5 == 0:
                    ...
                    torch.save(model, '/users/ad394h/Documents/segment_blood_vessels/models/Unet-Resnet_v2_mIoU-{:.3f}.pt'.format(test_iou_score/len(test_loader)))
...
torch.save(model, '/users/ad394h/Documents/segment_blood_vessels/models/Unet-Resnet-18_may_24.pt')
...
plot_loss(history)
plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/loss_history.jpg")
plot_score(history)
plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/score_history.jpg")
plot_acc(history)
plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/accuracy_history.jpg")
