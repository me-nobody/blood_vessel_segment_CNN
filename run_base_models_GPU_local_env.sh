...
#SBATCH --job-name=run_base_models   # some descriptive job name of your choice
...
srun python3 /users/ad394h/Documents/segment_blood_vessels/scripts/unet_efficientnet_base_models.py
