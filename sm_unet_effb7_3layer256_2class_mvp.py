...
log_file = '/users/ad394h/Documents/microvascular_proliferation/logs/sm_unet_effi_2_class_3layer256_mvp_{}.txt'.format(timestr)
...
model = torch.load('/users/ad394h/Documents/microvascular_proliferation/model/base_model/Unet_eff_b7_2class_depth3_256.pt')
...
timestr = time.strftime("%Y%m%d-%H%M%S")
try:    
    torch.save(model, '/users/ad394h/Documents/microvascular_proliferation/model/sm_unet_eff_b7_2class_3layer256_mvp_{}.pt'.format(timestr))
