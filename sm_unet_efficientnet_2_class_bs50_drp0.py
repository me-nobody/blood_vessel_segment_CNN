...
log_file = '/users/ad394h/Documents/segment_blood_vessels/logs/sm_unet_effi_2_class_bs10_drp0{}.txt'.format(timestr)
...
for lr in max_lr_list:
    logger.info("the learning_rate is {:.2f}".format(lr))
    file_name = "history_bs50_drp0_" + str(lr) + ".csv"
    ...
    plot_loss(history)
    plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs50_drp0_loss_{}.jpg".format(lr))
    plt.clf() # clear the above plot
    plot_score(history)
    plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs50_drp0_score_{}.jpg".format(lr))
    plt.clf()
    plot_acc(history)
    plt.savefig("/users/ad394h/Documents/segment_blood_vessels/tests/optimize_bs50_drp0_accuracy_{}.jpg".format(lr))
